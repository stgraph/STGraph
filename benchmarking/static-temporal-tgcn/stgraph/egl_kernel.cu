  ...
  int nodes_per_block) {
    ...
    if (dst_id < num_nodes) {
        ...
        for (; tx<feat_len; tx+=blockDim.x) {
            ...
            float V22_tmp = 0;
            int offset3 = dst_id * 16 + tx;int offset4 = dst_id * 1 + tx/16;
            ...
            for (int e=beg;e<end;++e) {
                ...
                int offset0 = src_id * 16 + tx;int offset1 = src_id * 1 + tx/16;int offset2 = eid * 1 + tx/16;
  ...
  int nodes_per_block) {
    ...
    if (src_id < num_nodes) {
        ...
        for (; tx<feat_len; tx+=blockDim.x) {
            ...
            float V28_tmp = 0;
            int offset3 = src_id * 1 + tx/16;int offset4 = src_id * 16 + tx;
            ...
            for (int e=beg;e<end;++e) {
                ...
                int offset0 = dst_id * 1 + tx/16;int offset1 = dst_id * 16 + tx;int offset2 = eid * 1 + tx/16;
